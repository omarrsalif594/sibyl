...
class ValidationTechnique(BaseTechnique):
    ...
    def __init__(self, config_path: Path | None = None) -> None:
        ...
        self._description = "Validation technique"
    ...
    def register_subtechnique(
        ...
        logger.debug("Registered validation subtechnique %s:%s", subtechnique_name, impl_name)
    ...
    def execute(
        ...
        **kwargs: Any,
        ...
        """Execute a validation subtechnique."""
    ...
    def load_config(self, config_path: Path) -> dict[str, Any]:
        if not config_path.exists():
            logger.warning("Config file not found for validation: %s", config_path)
            return {}
        try:
...
def build_technique(config_path: Path | None = None) -> ValidationTechnique:
    """Build and return a validation technique instance."""
    return ValidationTechnique(config_path=config_path)
