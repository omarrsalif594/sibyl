"""
Llm implementation for entity_linking.
"""
...
class LlmImplementation:
    ...
    def __init__(self) -> None:
        self._name = "llm"
        self._description = "Llm implementation"
    ...
    def execute(self, input_data: Any, config: dict[str, Any]) -> Any:
        ...
        confidence = config.get("entity_confidence", 0.7)

        metadata["entities"] = [
            {"value": entity, "method": "heuristic_llm", "confidence": confidence}
            for entity in entities
        ]
        metadata["entity_extraction"] = {
            "model": config.get("model", "lightweight"),
            "count": len(entities),
        }
