"""Query SQL technique orchestrator.

This technique manages SQL query and execution operations.
"""
...
class QuerySQLTechnique(BaseTechnique):
    """Technique for querying and executing SQL operations."""
    ...
    def execute(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            subtechnique: Subtechnique name (query or execute)
            variant: Variant name (default, provider, custom)
    ...
    def _discover_subtechniques(self) -> None:
        ...
        # Discover query and execute subtechniques
        for subtechnique_name in ["query", "execute"]:
        ...
        for variant in ["default", "provider", "custom"]:
            ...
            if variant_path.exists():
                try:
                    ...
                    module_path = f"sibyl.techniques.data_integration.query_sql.subtechniques.{subtechnique_name}.{variant}"
...
def build_technique(config_path: Path | None = None) -> QuerySQLTechnique:
    """Build and return the query SQL technique instance.

    Args:
        config_path: Optional path to technique config file

    Returns:
        QuerySQLTechnique instance
    """
    return QuerySQLTechnique(config_path)
