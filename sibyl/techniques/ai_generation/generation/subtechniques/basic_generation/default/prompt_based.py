"""
Prompt Based implementation for basic_generation.
"""
...
class PromptBasedImplementation:
    """Prompt Based implementation."""

    def __init__(self) -> None:
        self._name = "prompt_based"
        self._description = "Prompt Based implementation"
    ...
    def execute(self, input_data: Any, config: dict[str, Any]) -> Any:
        ...
        pieces = [p for p in [prefix, prompt, suffix] if p]
